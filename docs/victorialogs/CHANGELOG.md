...
* FEATURE: [web UI](https://docs.victoriametrics.com/victorialogs/querying/#web-ui): update hits query time display by renaming it to “Hits query” and repositioning it on the chart.
